...
-- Insert questions for the quiz
INSERT INTO Question (quizId, questionType, questionText, singleQuestionAnswer, alternativeAnswers, multipleChoiceAnswers, multipleChoiceCorrectIndexes, questionImage, multipleAnswerFields, matchingPairs)
VALUES (5, 1, 'Who won the FIFA World Cup in 2022?', 'France', NULL, NULL, NULL, NULL, NULL, NULL);
...
INSERT INTO Quiz (username, quizName, quizDescription, quizScore, questionIds, isSinglePage, randomizeQuestions, immediateFeedback, createTime)
VALUES ('KIKNA', 'ISE', 'GATESTE', 0, '[21, 22, 23, 24, 25, 26]', FALSE, FALSE, FALSE, CURRENT_TIMESTAMP);

INSERT INTO Question (quizId, questionType, questionText, singleQuestionAnswer, alternativeAnswers, multipleChoiceAnswers, multipleChoiceCorrectIndexes, questionImage, multipleAnswerFields, matchingPairs)
VALUES (6, 1, 'Who won the FIFA World Cup in 2018?', 'France', NULL, NULL, NULL, NULL, NULL, NULL);
...
INSERT INTO Question (quizId, questionType, questionText, singleQuestionAnswer, alternativeAnswers, multipleChoiceAnswers, multipleChoiceCorrectIndexes, questionImage, multipleAnswerFields, matchingPairs)
VALUES (6, 5, 'CHAMOTVALE 11-is JERADEBI ZRDADOBIT', NULL, NULL, NULL, NULL, NULL, ' [\" 11 \",\" 22 \", \" 33 \", \" 44 \", \" 55 \"] ', NULL);

INSERT INTO Question (quizId, questionType, questionText, singleQuestionAnswer, alternativeAnswers, multipleChoiceAnswers, multipleChoiceCorrectIndexes, questionImage, multipleAnswerFields, matchingPairs)
VALUES (6, 6, 'Please mark each statement below which is true', NULL, NULL, ' [\" a \", \" b \", \" c \"] ', ' [0, 2] ', NULL, NULL, NULL);
